...
# Loxia curvirostra crivirostra is the subspecies for Loxia curvirostra (common
# crossbill). Generally recorded the same so may be better to merge. Use a
# conditional search with == inside square brackets to replace subspecies 
# with species
